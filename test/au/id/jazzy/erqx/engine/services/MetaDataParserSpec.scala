  ...
  "meta data parser" should {
    "extract data from the front matter" in {
      MetaDataParser.parsePostFrontMatter(frontMatter(
        ...
        BlogPost("someid", "some/path", "Some title", date(2013, 11, 16), "nobody", "some_name", "md", Set("foo", "bar"))
    }
    "use name as id if not specified" in {
      MetaDataParser.parsePostFrontMatter(frontMatter(
        ...
        BlogPost("2012-10-15-some_name", "some/path", "Some title", date(2013, 11, 16), "nobody", "some_name", "md",
          Set("foo", "bar"))
    }
    "extract title from name if not specified" in {
      MetaDataParser.parsePostFrontMatter(frontMatter(
        ...
        BlogPost("someid", "some/path", "some name", date(2013, 11, 16), "nobody", "some_name", "md", Set("foo", "bar"))
    }
    "extract date from name if not specified" in {
      MetaDataParser.parsePostFrontMatter(frontMatter(
        ...
        BlogPost("someid", "some/path", "Some title", new DateTime(2012, 10, 15, 0, 0), "nobody", "some_name", "md", Set("foo", "bar"))
    }
    "work from name if nothing specified" in {
      MetaDataParser.parsePostFrontMatter(frontMatter(
      ), "some/path", "2012-10-15-some_name.md") ===
        BlogPost("2012-10-15-some_name", "some/path", "some name", new DateTime(2012, 10, 15, 0, 0), "nobody", "some_name", "md", Set())
    }
    "allow dates with hours and minutes" in {
      MetaDataParser.parsePostFrontMatter(frontMatter(
        "date" -> "2013-11-16T13:33:00.0Z"
      ), "some/path", "2012-10-15-some_name.md") ===
        BlogPost("2012-10-15-some_name", "some/path", "some name", date(2013, 11, 16, 13, 33), "nobody", "some_name", "md", Set())
    }
    "allow tags with escaped spaces" in {
      MetaDataParser.parsePostFrontMatter(frontMatter(
        "tags" -> "foo+bar"
      ), "some/path", "2012-10-15-some_name.md") ===
        BlogPost("2012-10-15-some_name", "some/path", "some name", new DateTime(2012, 10, 15, 0, 0), "nobody", "some_name", "md", Set("foo bar"))
    }
    ...
    "allow colons in the title" in {
      MetaDataParser.parsePostFrontMatter(frontMatter(
        ...
        BlogPost("2012-10-15-some_name", "some/path", "This: is a blog post", new DateTime(2012, 10, 15, 0, 0), "nobody", "some_name", "md", Set())
    }
  }
