 ...
 */
final case class BlogPost(id: String, path: String, title: String, date: DateTime, author: String,
                          permalinkTitle: String, format: String, tags: Set[String], properties: Yaml = Yaml.empty) {
